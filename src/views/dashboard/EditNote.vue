    ...
    export default {
        ...
        methods: {
            async getNote() {
                ...
                try {
                    const response = await axios.get(`/api/notes/${noteID}/?client_id=${clientID}`)
            ...
            async submitForm() {
                ...
                const clientID = this.$route.params.id
                try {
                    const response = await axios.patch(`/api/notes/${this.note.id}/?client_id=${clientID}`, this.note)
                    toast({
