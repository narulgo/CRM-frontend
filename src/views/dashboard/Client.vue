        ...
        <div class="columns is-multiline">
            ...
            <div class="column is-12">
                ...
                >
                    ...
                    <router-link to="/dashboard/clients/:id/edit-note/:note_id" class="button is-success mt-6">Edit note</router-link>
                </div>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            async deleteClient() {
                ...
                try {
                    const response = await axios.post(`/api/clients/delete_client/${clientID}/`)
            ...
            async getClient() {
                ...
                try {
                    const response = await axios.get(`/api/notes/?client_id=${clientID}/`)
